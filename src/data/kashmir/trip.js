...
export const trip = {
  ...
  startingPoint: "Delhi",
  endingPoint: "Delhi",
  transport: ["Express Train (Sleeper)", "Local DEMU Train", "Shared Cabs", "Shikara Boat"],
  theme: "Teal",
  version: "1.0.0",
  developer: "Trip Team",
};
...
export const routeTimeline = [
  ...
  { id: 4, location: "Srinagar (Dal Lake)", altitude: "1,585m", distance: "830 km", day: 1, date: "Day 1 Evening", arrTime: "03:45 PM", depTime: "—", transport: "Shikara Ride to Houseboat", icon: "Home" },
  { id: 5, location: "Gulmarg Meadows", altitude: "2,650m", distance: "885 km", day: 2, date: "Day 2 Daytrip", arrTime: "09:30 AM", depTime: "05:00 PM", transport: "Shared Cab to Tangmarg & Gulmarg", icon: "Bus" },
  { id: 6, location: "Pahalgam Valley", altitude: "2,200m", distance: "925 km", day: 3, date: "Day 3 Daytrip", arrTime: "09:30 AM", depTime: "05:00 PM", transport: "Shared Cab to Lidder Valley", icon: "Bus" },
  { id: 7, location: "Srinagar (Local)", altitude: "1,585m", distance: "830 km", day: 4, date: "Day 4 Full Day", arrTime: "—", depTime: "—", transport: "Walk to Mughal Gardens & Old Town", icon: "Compass" },
  { id: 8, location: "Jammu (Return Transit)", altitude: "327m", distance: "1120 km", day: 5, date: "Day 5 Evening", arrTime: "05:30 PM", depTime: "08:10 PM", transport: "Sleeper Train back to Delhi", icon: "Train" },
...
export const overviewCards = [
  { title: "Kashmir Valley Train Ride", value: "Banihal to Srinagar", description: "Experience the gorgeous rail journey passing through the 11.2 km long Pir Panjal railway tunnel.", icon: "Train" },
  { title: "Gulmarg Gondola & Slopes", description: "Walk through high-altitude pine forests and take a cable car ride overlooking Gulmarg's massive snow peaks.", icon: "TrendingUp" },
...
export const STORAGE_KEYS = {
  expenseTracker: "expenses-kashmir",
  budgetCalculator: "budget-values-kashmir",
  completedTreks: "completed-treks-kashmir",
  packingChecklist: "packing-checklist-kashmir",
  completedDays: "completed-days-kashmir",
};
