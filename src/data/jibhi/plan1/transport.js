...
export const transport = [
  ...
  { id: 3, from: "Jibhi", to: "Jalori Pass", mode: "Scooter Ride", distance: "12 km", duration: "45 mins", fare: data.transportFares.scootyRental, cheapest: 500, alternative: "Local Bus (₹40)", frequency: "On demand rental", notes: "2 scooters for 4 people (₹500 per day rental fee per scooter)", busType: "Scooter" },
