...
export const transport = [
  {
    ...
    notes: "Overnight semi-sleeper AC Volvo bus journey from Delhi to Manali",
    busType: "AC Volvo"
  },
  {
    id: 2,
    ...
    notes: "Renting Scooty @ ₹500/person (split by 2 riders) for local sightseeing & cafe hopping",
    busType: "Scooter"
  },
  {
    id: 3,
    ...
    frequency: "Xpulse Day 1 Ride",
    notes: "Transit through 9 km Atal Tunnel, off-roading past Batal, scale Kunzum Pass (14,931 ft)",
    busType: "Motorcycle"
  },
  {
    id: 4,
  ...
  },
  {
    ...
    frequency: "Xpulse Day 3 Return Ride",
    notes: "Off-road detour to turquoise Chandratal Moon Lake, cross Kunzum Pass & return Xpulse in Manali",
    busType: "Motorcycle"
  },
  {
    id: 6,
    ...
    notes: "Renting Scooty @ ₹500/person (split by 2 riders) for 2nd day local riding & souvenir shopping",
    busType: "Scooter"
  }
];
