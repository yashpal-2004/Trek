      ...
      plans: [
        {
          ...
          duration: "6 Days",
          route: "Sonipat → Delhi → Manali → Kaza → Key & High Villages → Chandratal → Manali → Delhi → Sonipat",
          details: "Delhi-Manali Volvo round-trip + 4-day Royal Enfield Himalayan rental (no Manali hotels, overnight camping at Chandratal).",
