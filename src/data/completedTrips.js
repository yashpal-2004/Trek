export const completedTrips = [
  ...
  },
  {
    ...
    image: "/mountain_clay_peak.png",
    expenses: [
      { category: "Intercity Transit", description: "RedBus Volvo / Express Transit", amount: 900.00 },
      { category: "Shared Expenses", description: "Other Shared Trip Expenses", amount: 1031.50 },
      { category: "Accommodation", description: "Hotel Stay (3 Days)", amount: 770.00 },
      { category: "Scooty Rental", description: "3 Days Scooty Rental", amount: 750.00 },
      { category: "Food", description: "Meals & Dining", amount: 400.00 },
      { category: "Fuel", description: "Scooty Petrol / Fuel", amount: 250.00 },
      { category: "Snacks", description: "Trail & Travel Snacks", amount: 100.00 },
    ],
    plans: [
      {
