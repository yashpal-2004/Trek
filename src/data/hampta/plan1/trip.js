...
export const trip = {
  ...
  subtitle: "A 5-day classic crossover trek from lush green Kullu Valley to the barren mountain landscape of Lahaul, ending with high-altitude Chandra Tal lake",
  duration: "10 Aug – 14 Aug 2026",
  durationDays: 5,
  people: 2,
  get budgetMin() { return budgetData.total; },
  get budgetMax() { return budgetData.total + 1500; },
  difficulty: "Moderate",
...
export const quickStats = [
  { id: "days", label: "Total Days", value: 5, suffix: "", description: "Expedition Crossover", icon: "Calendar" },
  ...
  { id: "destinations", label: "Key Stops", value: 6, suffix: "", description: "Chika, Balu Ka Ghera, Shea Goru, Chatru, Chandra Tal", icon: "MapPin" },
];
...
export const routeTimeline = [
  ...
  { id: 8, location: "Chatru Camp", altitude: "3350m", distance: "12 km", day: 4, date: "13 Aug", arrTime: "01:00 PM", depTime: "02:00 PM", transport: "Shared Taxi", icon: "Mountain" },
  { id: 9, location: "Chandra Tal Lake", altitude: "4250m", distance: "45 km", day: 4, date: "13 Aug", arrTime: "04:30 PM", depTime: "06:30 AM (Next Day)", transport: "Shared Taxi", icon: "MapPin" },
  { id: 10, location: "Manali via Rohtang", altitude: "2050m", distance: "110 km", day: 5, date: "14 Aug", arrTime: "01:00 PM", depTime: "06:00 PM", transport: "Overnight Volvo Bus", icon: "MapPin" },
  { id: 11, location: "Delhi", altitude: "215m", distance: "530 km", day: 6, date: "15 Aug", arrTime: "07:00 AM", transport: "Bus", icon: "Home" },
];

export const overviewCards = [
  { id: "duration", label: "Duration", value: "5 Days", icon: "Calendar", description: "10 Aug – 14 Aug 2026" },
  { id: "budget", label: "Budget", get value() { return `₹${(budgetData.total / 1000).toFixed(1)}K–${((budgetData.total + 1500) / 1000).toFixed(1)}K`; }, icon: "Wallet", description: "Per person estimate" },
  { id: "difficulty", label: "Difficulty", value: "Moderate", icon: "Activity", description: "Crossover pass expedition" },
  ...
  { id: "distance", label: "Total Distance", value: "1095 km", icon: "Route", description: "Delhi transit + 35 km trek" },
  { id: "altitude", label: "Highest Point", value: "4,270m (14,010 ft)", icon: "TrendingUp", description: "Hampta Pass Summit" },
  { id: "weather", label: "Season", value: "Aug Monsoon", icon: "CloudRain", description: "Lush meadows to dry desert" },
];
...
export const STORAGE_KEYS = {
  tripProgress: "trip-progress-hampta-plan1",
  packingChecklist: "packing-checklist-hampta-plan1",
  expenseTracker: "expense-tracker-hampta-plan1",
  theme: "theme-hampta-plan1",
  completedDays: "completed-days-hampta-plan1",
  favoritePlaces: "favorite-places-hampta-plan1",
  completedTreks: "completed-treks-hampta-plan1",
  budgetCalculator: "budget-calculator-hampta-plan1",
};
