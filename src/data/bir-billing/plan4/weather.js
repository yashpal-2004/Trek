...
export const safety = [
  { id: 1, title: "Equipment Safety check", icon: "Shield", description: "Ensure helmet straps, reserve chute pin, and harness buckles are fully locked if paragliding.", tips: ["Verify before runway run", "Check paraglider wing lines for twists"] },
