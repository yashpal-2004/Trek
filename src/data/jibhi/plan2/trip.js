...
export const trip = {
  title: "Jibhi Valley Solo Explorer",
  subtitle: "A 4-day solo backpacker exploration and pass trek starting from Sonipat",
  duration: "27 Aug - 31 Aug 2026",
  durationDays: 4,
  people: 1,
  get budgetMin() { return data.budgetTotal - 300; },
  ...
  endingPoint: "Sonipat",
  transport: ["Volvo Bus", "Local Bus", "Scooter"],
  theme: "Emerald",
  version: "1.0.0",
  developer: "Trip Team",
};
...
export const routeTimeline = [
  ...
  { id: 3, location: "Jibhi Valley", altitude: "1600m", distance: "30 km (Bus)", day: 1, date: "28 Aug", arrTime: "09:30 AM", depTime: "08:00 AM (30 Aug)", transport: "Hostel Dorm Bed stay", icon: "Home" },
...
export const overviewCards = [
  ...
  { title: "Hostel Community", value: "Backpacker Dorms", description: "Connect with travelers, sit by bonfires, and enjoy acoustic nights.", icon: "Home" },
];
...
export const STORAGE_KEYS = {
  expenseTracker: "expenses-jibhi-plan2",
  budgetCalculator: "budget-values-jibhi-plan2",
  completedTreks: "completed-treks-jibhi-plan2",
  packingChecklist: "packing-checklist-jibhi-plan2",
  completedDays: "completed-days-jibhi-plan2",
};
