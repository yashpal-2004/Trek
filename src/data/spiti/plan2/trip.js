...
export const trip = {
  title: "Spiti Valley Expedition — Plan 2 (4 Persons)",
  subtitle: "A 6-day mountain riding adventure optimized for 4 friends with shared quad stays, 2 Xpulse bikes & 2 Manali scooties",
  ...
  startingPoint: "Delhi",
  endingPoint: "Delhi",
  transport: ["Volvo Bus", "Hero Xpulse 200 (x2)", "Scooty (x2)"],
  theme: "Amber",
  version: "1.0.0",
  developer: "Trip Team",
};
...
export const quickStats = [
  ...
  { id: "budget", label: "Budget", value: (spitiAmounts.plan2.budgetTotal / 1000).toFixed(1), suffix: "K", prefix: "₹", description: "Per person (4 friends group)", icon: "Wallet" },
...
export const overviewCards = [
  ...
  { title: "Group Savings (4 Persons)", value: "Save ~₹800 Each", description: "Quad-sharing homestay & hotel room savings with shared permit fees for a group of 4.", icon: "Wallet" },
];
...
export const STORAGE_KEYS = {
  expenseTracker: "expenses-spiti-p2",
  budgetCalculator: "budget-values-spiti-p2",
  completedTreks: "completed-treks-spiti-p2",
  packingChecklist: "packing-checklist-spiti-p2",
  completedDays: "completed-days-spiti-p2",
};
