...
export const budget = {
  ...
  categories: [
    { 
      ...
      color: "#3B82F6", 
      icon: "Bus", 
      description: "Sonipat-Bir overnight semi-sleeper Volvo + solo scooter rental & petrol",
      subItems: [
        { name: "Sonipat → Bir Volvo Round Trip", price: 1200 },
        { name: "Local Scooty Rental (1 scooter for 1 day)", price: 500 },
        { name: "Petrol / Fuel for Scooty", price: 400 }
      ]
    },
    { 
      id: "accommodation", 
  ...
  dailyEstimate: [
    { day: 1, amount: 1300, label: "Sonipat → Bir transit & monastery sightseeing by scooter" },
    { day: 2, amount: 1800, label: "Trek or scooter ride up to Billing & sunset ridge camping" },
    { day: 3, amount: 1750, label: "Scooter ride back down to Bir, cafe hopping & overnight bus to Sonipat" },
  ],
