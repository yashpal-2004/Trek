...
export const trip = {
  title: "Bir Billing (Solo Flyer - With Flight)",
  subtitle: "A 4-day solo weekend escape to Bir Billing with paragliding flight, scooter exploration, and ridge camping",
  duration: "27 Aug - 31 Aug 2026",
  durationDays: 4,
  people: 1,
  get budgetMin() { return data.budgetTotal - 400; },
  get budgetMax() { return data.budgetTotal + 700; },
  ...
  endingPoint: "Sonipat",
  transport: ["Volvo Bus", "Scooter", "Paragliding"],
  theme: "Rose",
  version: "1.0.0",
  developer: "Trip Team",
};
...
export const quickStats = [
  ...
  { id: "budget", label: "Budget", get value() { return (data.budgetTotal / 1000).toFixed(1); }, suffix: "K", prefix: "₹", description: "Solo flyer estimate", icon: "Wallet" },
  { id: "altitude", label: "Highest Point", value: 2400, suffix: " M (7,874 FT)", description: "Billing Ridge Takeoff", icon: "TrendingUp" },
  { id: "distance", label: "Total Distance", value: 907, suffix: " KM", description: "Volvo bus & paragliding", icon: "Route" },
...
export const routeTimeline = [
  ...
  { id: 3, location: "Billing Take-off", altitude: "2400m", distance: "7 km (Trek)", day: 2, date: "29 Aug", arrTime: "02:00 PM", depTime: "08:30 AM (30 Aug)", transport: "Scooter / Trek", icon: "Footprints" },
...
export const STORAGE_KEYS = {
  expenseTracker: "expenses-bir-billing-plan3",
  budgetCalculator: "budget-values-bir-billing-plan3",
  completedTreks: "completed-treks-bir-billing-plan3",
  packingChecklist: "packing-checklist-bir-billing-plan3",
  completedDays: "completed-days-bir-billing-plan3",
};
