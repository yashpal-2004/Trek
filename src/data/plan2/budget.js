export const budget = {
  ...
  currency: "INR",
  categories: [
    { id: "transport", label: "Transportation", amount: 2400, color: "#2563EB", icon: "Bus", description: "Train, bus, jeep, shared transport" },
    { id: "accommodation", label: "Accommodation", amount: 2500, color: "#10B981", icon: "Bed", description: "Hostels, GMVN, homestays, temple stays" },
    { id: "food", label: "Food", amount: 1660, color: "#F59E0B", icon: "Utensils", description: "Meals, snacks, water" },
