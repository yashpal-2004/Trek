export const budget = {
  ...
  currency: "INR",
  categories: [
    { id: "transport", label: "Transportation", amount: 3150, color: "#2563EB", icon: "Bus", description: "Volvo bus to Manali, local shared cabs to Jobra and Chatru/Chandra Tal" },
    { id: "accommodation", label: "Accommodation & Tents", amount: 2100, color: "#10B981", icon: "Bed", description: "Tent rentals at Chika, Balu Ka Ghera, Shea Goru and Chandra Tal (4 Nights)" },
    { id: "food", label: "Food & Meals", amount: 1950, color: "#F59E0B", icon: "Utensils", description: "Lahaul local dhabas, trail mixes, camp breakfasts/dinners" },
  ...
  dailyEstimate: [
    ...
    { day: 4, amount: 1100, label: "Shea Goru → Chatru → Chandra Tal" },
    { day: 5, amount: 1500, label: "Chandra Tal → Manali → Delhi" },
  ],
  calculatorDefaults: { transport: 3150, stay: 2100, food: 1950, emergency: 0, permits: 100 },
};
...
export const stayOptions = [
  ...
  {
    id: 4,
    destination: "Chandra Tal Lake",
    image: "https://images.unsplash.com/photo-1439853949212-36589f9a6ab9?w=800&q=80",
    budget: 600,
    mid: 800,
    premium: 1200,
    gmvnn: false,
    camping: true,
    hostel: false,
    facilities: ["Glamping Tents", "Dining Area", "Warm Blankets"],
    pros: ["Lakeside proximity (3km off-limits zone)", "Incredible night sky/stargazing"],
    cons: ["Extreme high altitude (4,250m)", "No network, remote location"],
    name: "Moon Lake Glamping Tents",
    notes: "Camping directly at the lake shore is banned; camps are situated 3km away",
    hotels: [
      { name: "Deluxe Camping Tents", price: 600, offline: true },
      { name: "Premium Swiss Tents (Attached toilet)", price: 1100, offline: true }
    ]
  }
];
