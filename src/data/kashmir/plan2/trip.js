...
export const quickStats = [
  ...
  { id: "budget", label: "Budget", value: parseFloat((kashmirPlan2Amounts.budgetTotal / 1000).toFixed(2)), suffix: "K", prefix: "₹", description: "Per person (2 people sharing bike/stay)", icon: "Wallet" },
