export const transport = [
  ...
  { id: 7, from: "Chatru Camp", to: "Manali", mode: "Shared Cab", distance: "110 km", duration: "5 hrs", fare: 650, cheapest: 650, alternative: "State Bus (₹150)", frequency: "Morning only", notes: "Return drive via Atal Tunnel / Rohtang Pass, bypassing Chandra Tal", busType: "Tata Sumo / Bolero" },
  { id: 8, from: "Manali", to: "Delhi", mode: "Volvo Bus", distance: "530 km", duration: "12 hrs", fare: 850, cheapest: 850, alternative: "HRTC Ordinary Bus", frequency: "Hourly (Overnight)", notes: "Overnight semi-sleeper AC Volvo bus returning to Delhi", busType: "AC Volvo Semi-Sleeper" },
];
