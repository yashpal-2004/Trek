export const routeWaypoints = [
  ...
  { id: 15, name: "Ramaya Homestay", altitude: 81, altLabel: "81m", distance: 781, type: "stay", category: "Base Stay", description: "Base homestay near Kal Bhairav & Kashi Vishwanath.", highlight: true },
  ...
  { id: 16, name: "Godowlia Chowk Food Walk", altitude: 81, altLabel: "81m", distance: 790, type: "food", category: "Local Food", description: "MUST TRY: Blue Lassi, Kashi Tamatar Chaat, Baati Chokha & Meetha Banarasi Paan!", highlight: true },
  { id: 9, name: "Assi Ghat Subah-e-Banaras", altitude: 81, altLabel: "81m", distance: 792, type: "landmark", category: "River Ghat", description: "MUST TRY: Hot Poori Jalebi & Kulhad Chai post morning boat ride.", highlight: true },
  ...
  { id: 11, name: "BHU New Vishwanath Temple (VT)", altitude: 81, altLabel: "81m", distance: 798, type: "landmark", category: "Temple", description: "MUST TRY: Legendary BHU VT Cold Coffee, Samosa & Chola Samose!", highlight: true },
