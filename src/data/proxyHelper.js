...
export const getParentTripId = () => {
  ...
  if (key === 'binsar') return 'binsar';
  if (key === 'moon-peak') return 'moon-peak';
  if (key === 'somnath-nageshwar' || key === 'somnath-nageshwar-plan1' || key === 'somnath-nageshwar-plan2' || key === 'somnath' || key === 'nageshwar' || key === 'gujarat-jyotirlinga') return 'somnath-nageshwar';
  return key;
};
...
export const createDynamicProxy = (...args) => {
  ...
  const getActiveData = () => {
    ...
    if (key === "kashmir-plan3") return typeof getters[41] === "function" ? getters[41]() : getters[0]();
    ...
    if (key === "somnath-nageshwar" || key === "somnath-nageshwar-plan1" || key === "somnath" || key === "nageshwar" || key === "gujarat-jyotirlinga") return typeof getters[36] === "function" ? getters[36]() : getters[0]();
    if (key === "somnath-nageshwar-plan2") return typeof getters[42] === "function" ? getters[42]() : typeof getters[1] === "function" ? getters[1]() : getters[0]();
